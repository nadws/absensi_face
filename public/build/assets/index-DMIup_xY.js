import{r as at,j as x,a as Je}from"./app-B4Ukg5N5.js";import{z as Ze}from"./transition-QjNedhhF.js";const Tt=at.createContext(),Ft=({children:t})=>{const[e,n]=at.useState(!1),a=()=>{n(r=>!r)};return x.jsx(Tt.Provider,{value:{open:e,setOpen:n,toggleOpen:a},children:x.jsx("div",{className:"relative",children:t})})},tn=({children:t,icon:e="",active:n=!1})=>{const{open:a,setOpen:r,toggleOpen:i}=at.useContext(Tt);return x.jsxs(x.Fragment,{children:[x.jsx("div",{onClick:i,children:t}),a&&x.jsx("div",{className:"fixed inset-0 z-40",onClick:()=>r(!1)})]})},en=({align:t="right",width:e="48",contentClasses:n="py-1 bg-white",children:a})=>{const{open:r,setOpen:i}=at.useContext(Tt);let o="origin-top";t==="left"?o="ltr:origin-top-left rtl:origin-top-right start-0":t==="right"&&(o="ltr:origin-top-right rtl:origin-top-left end-0");let l="";return e==="48"&&(l="w-48"),x.jsx(x.Fragment,{children:x.jsx(Ze,{show:r,enter:"transition ease-out duration-200",enterFrom:"opacity-0 scale-95",enterTo:"opacity-100 scale-100",leave:"transition ease-in duration-75",leaveFrom:"opacity-100 scale-100",leaveTo:"opacity-0 scale-95",children:x.jsx("div",{className:`absolute z-50 mt-2 rounded-md shadow-lg ${o} ${l}`,onClick:()=>i(!1),children:x.jsx("div",{className:"rounded-md ring-1 ring-black ring-opacity-5 "+n,children:a})})})})},nn=({className:t="",children:e,active:n=!1,...a})=>x.jsx(Je,{...a,className:"block w-full px-4 py-2 text-start text-sm leading-5  hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out "+(n?"text-[#F46700]":"text-gray-700")+t,children:e});Ft.Trigger=tn;Ft.Content=en;Ft.Link=nn;/*!
